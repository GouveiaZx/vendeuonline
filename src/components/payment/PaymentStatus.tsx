...
import { AsaasPaymentResponse } from '../../services/asaasService';
...
const PaymentStatus: React.FC<PaymentStatusProps> = ({ payment, onRetry, onClose }) => {
  ...
  const billingTypeInfo = getBillingTypeInfo(payment.billingType);
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="p-6 bg-gray-50 border-t space-y-3">
        ...
        {/* PIX QR Code */}
        {payment.billingType === 'PIX' && payment.pixTransaction && (
