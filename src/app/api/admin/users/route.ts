...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`👨‍💻 Admin ${admin.email} acessou lista de usuários`);
...
// POST /api/admin/users - Criar novo usuário (ADMIN ONLY)
export async function POST(request: NextRequest) {
  try {
    // Verificar se é admin
    const admin = await requireAdmin(request);
    console.log(`👨‍💻 Admin ${admin.email} criando novo usuário`);
